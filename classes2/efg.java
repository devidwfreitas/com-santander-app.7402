...
class efg implements efe {
  private IBinder a;
  
  efg(IBinder paramIBinder) {
    this.a = paramIBinder;
  }
  ...
  public void a() {
    ...
    try {
      parcel1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
  ...
  public boolean a(efe paramefe) {
    ...
    try {
      parcel1.writeInterfaceToken("com.google.android.gms.maps.model.internal.ITileOverlayDelegate");
      if (paramefe != null) {
        IBinder iBinder = paramefe.asBinder();
      } else {
        paramefe = null;
      } 
      parcel1.writeStrongBinder((IBinder)paramefe);
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\efg.class
