...
public class mbh implements CompoundButton.OnCheckedChangeListener {
  public mbh(ContractPaymentView paramContractPaymentView) {}
  
  public void onCheckedChanged(CompoundButton paramCompoundButton, boolean paramBoolean) {
    if (paramBoolean) {
      paramCompoundButton.setButtonTintList(ContextCompat.getColorStateList(this.a.getContext(), 2131624409));
      ContractPaymentView.b(this.a).setChecked(false);
      ContractPaymentView.c(this.a).a();
      ContractPaymentView.a(this.a, 0);
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\mbh.class
