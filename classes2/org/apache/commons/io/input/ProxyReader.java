...
public abstract class ProxyReader extends FilterReader {
  ...
  public void mark(int paramInt) {
    ...
    //   14: aload_0
    //   15: aload_2
    //   16: invokevirtual handleIOException : (Ljava/io/IOException;)V
    //   19: goto -> 10
    //   22: astore_2
    //   23: aload_0
    //   24: monitorexit
  ...
  public int read(CharBuffer paramCharBuffer) {
    ...
    int i = 0;
    beforeRead(i);
    i = this.in.read((CharBuffer)iOException);
    afterRead(i);
    return i;
  }
  ...
  public int read(char[] paramArrayOfchar) {
    ...
    int i = 0;
    beforeRead(i);
    i = this.in.read((char[])iOException);
    afterRead(i);
    return i;
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\apache\commons\io\input\ProxyReader.class
