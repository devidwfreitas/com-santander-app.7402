...
class ElementListUnionLabel extends TemplateLabel {
  ...
  public ElementListUnionLabel(Contact paramContact, ElementListUnion paramElementListUnion, ElementList paramElementList, Format paramFormat) {
    ...
    this.extractor = new GroupExtractor(paramContact, (Annotation)paramElementListUnion, paramFormat);
  ...
  public Converter getConverter(Context paramContext) {
    ...
    return new CompositeListUnion(paramContext, this.extractor, expression, contact);
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\simpleframework\xml\core\ElementListUnionLabel.class
