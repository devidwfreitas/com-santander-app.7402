  ...
  public static String evaluate(List<List> paramList, Navigator paramNavigator) {
    if (!paramList.isEmpty()) {
      ...
      if (paramNavigator.isElement(paramList))
        return paramNavigator.getElementQName(paramList); 
      if (paramNavigator.isAttribute(paramList))
        return paramNavigator.getAttributeQName(paramList); 
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\jaxen\function\NameFunction.class
