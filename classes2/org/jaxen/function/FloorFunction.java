...
public class FloorFunction implements Function {
  public static Double evaluate(Object paramObject, Navigator paramNavigator) {
    return new Double(Math.floor(NumberFunction.evaluate(paramObject, paramNavigator).doubleValue()));
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\jaxen\function\FloorFunction.class
