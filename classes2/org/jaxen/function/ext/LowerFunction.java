...
public class LowerFunction extends LocaleFunctionSupport {
  public static String evaluate(Object paramObject, Locale paramLocale, Navigator paramNavigator) {
    ...
    return str.toLowerCase((Locale)paramObject);
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\jaxen\function\ext\LowerFunction.class
