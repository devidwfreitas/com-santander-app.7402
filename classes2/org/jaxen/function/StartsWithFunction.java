...
public class StartsWithFunction implements Function {
  public static Boolean evaluate(Object paramObject1, Object paramObject2, Navigator paramNavigator) {
    return StringFunction.evaluate(paramObject1, paramNavigator).startsWith(StringFunction.evaluate(paramObject2, paramNavigator)) ? Boolean.TRUE : Boolean.FALSE;
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\jaxen\function\StartsWithFunction.class
