...
class TokenTypes {
  ...
  static String getTokenText(int paramInt) {
    switch (paramInt) {
      default:
        return "Unrecognized token type: " + paramInt;
      case -3:
        return "(error)";
      case -2:
        return "(skip)";
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\jaxen\saxpath\base\TokenTypes.class
