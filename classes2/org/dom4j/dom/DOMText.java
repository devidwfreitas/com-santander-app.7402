...
public class DOMText extends DefaultText implements Text {
  public DOMText(String paramString) {
    super(paramString);
  }
  
  public DOMText(Element paramElement, String paramString) {
  ...
  protected Text createText(String paramString) {
  ...
  public Text splitText(int paramInt) {
    ...
    Text text = createText(str2);
    if (element != null)
      element.add(text); 
    return DOMNodeHelper.asDOMText((CharacterData)text);
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\org\dom4j\dom\DOMText.class
