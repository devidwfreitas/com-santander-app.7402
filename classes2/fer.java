...
public class fer extends few {
  private static final String a = fer.class.getSimpleName();
  
  protected float a(fdu paramfdu1, fdu paramfdu2) {
    if (paramfdu1.a <= 0 || paramfdu1.b <= 0)
      return 0.0F; 
    fdu fdu1 = paramfdu1.a(paramfdu2);
    float f2 = fdu1.a * 1.0F / paramfdu1.a;
    float f1 = f2;
    if (f2 > 1.0F)
      f1 = (float)Math.pow((1.0F / f2), 1.1D); 
    f2 = paramfdu2.a * 1.0F / fdu1.a;
    f2 = paramfdu2.b * 1.0F / fdu1.b * f2;
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\fer.class
