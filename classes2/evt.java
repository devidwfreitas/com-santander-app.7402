  ...
  static {
    ...
    a = new int[][] { 
        arrayOfInt1, { 
          ...
          183, 182, 189, 188, 195, 194, 201, 200, 816, -3 }, arrayOfInt2, arrayOfInt3, arrayOfInt4, arrayOfInt5, arrayOfInt6, arrayOfInt7, arrayOfInt8, arrayOfInt9, 
        arrayOfInt10, arrayOfInt11, { 
          415, 414, 421, 420, 427, 426, 103, 102, 55, 54, 
          16, -3, -3, -3, -3, -3, -3, -3, 20, 19, 
          85, 84, 433, 432, 439, 438, 445, 444, 833, 832 }, arrayOfInt12, arrayOfInt13, arrayOfInt14, arrayOfInt15, arrayOfInt16, arrayOfInt17, arrayOfInt18, 
        arrayOfInt19, arrayOfInt20, arrayOfInt21, arrayOfInt22, arrayOfInt23, arrayOfInt24, { 
          569, 568, 575, 574, 581, 580, 587, 586, 593, 592, 
          599, 598, 605, 604, 611, 610, 617, 616, 623, 622, 
          629, 628, 635, 634, 641, 640, 647, 646, 854, 853 }, arrayOfInt25, { 
          729, 728, 723, 722, 717, 716, 711, 710, 705, 704, 
          699, 698, 693, 692, 687, 686, 681, 680, 675, 674, 
          669, 668, 663, 662, 657, 656, 651, 650, 857, 856 }, arrayOfInt26, 
        arrayOfInt27, arrayOfInt28, arrayOfInt29 };
  }
  ...
  byte[] a() {
    ...
    for (int i = 0; i < j; i++) {
      ...
      for (int m = 0; m < k; m++) {
        ...
        if (n >= 0 && this.b.a(m, i)) {
          int i1 = n / 6;
          byte b = arrayOfByte[i1];
          arrayOfByte[i1] = (byte)((byte)(1 << 5 - n % 6) | b);
        } 
      } 
    } 
    return arrayOfByte;
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\evt.class
