...
final class nan implements TextWatcher {
  private boolean c;
  
  private String d = "";
  
  nan(nap paramnap, EditText paramEditText) {}
  ...
  public void onTextChanged(CharSequence paramCharSequence, int paramInt1, int paramInt2, int paramInt3) {
    String str = nam.a(paramCharSequence.toString());
    switch (nao.a[this.a.ordinal()]) {
      default:
        paramCharSequence = nam.b(str);
        if (this.c) {
          this.d = str;
          this.c = false;
          return;
