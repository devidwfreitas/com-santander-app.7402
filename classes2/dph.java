public final class dph extends dqy<dph> {
  private static volatile dph[] e;
  ...
  protected int a() {
    ...
    j = i;
    if (this.d != null)
      j = i + dqw.b(4, this.d.booleanValue()); 
    return j;
  }
  
  public dph a(dqv paramdqv) {
    while (true) {
      int i = paramdqv.a();
      switch (i) {
        case 0:
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\dph.class
