...
class gli implements View.OnClickListener {
  gli(glf paramglf, int paramInt) {}
  ...
  public void onClick(View paramView) {
    ...
    if (gld.f(this.b.c) == null)
      this.b.c.a(ghu); 
    this.b.c.a(this.a);
    frq.d("Fatura_Acao", "AcessoRapidoHomeFaturas");
    if (ghu.z() != null) {
      if (mzr.a()) {
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\gli.class
