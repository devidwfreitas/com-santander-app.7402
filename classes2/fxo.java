...
public class fxo implements fzi {
  public fxo(QuizStartActivity paramQuizStartActivity) {}
    ...
    if (paramObject != null) {
      if (!paramObject.b().equals("0")) {
        if (paramObject.b().equals("@ERSNE2015")) {
          mxn.a(QuizStartActivity.d(this.a), 2130968942);
          return;
        } 
        if (paramObject.b().equals("-1")) {
          mxn.a(QuizStartActivity.d(this.a), paramObject.d(), true);
          return;
        } 
        mxn.e(QuizStartActivity.d(this.a), "Sistema indisponível. Por favor, entre em contato com a Central de Atendimento Santander.");
        return;
      } 
      QuizStartActivity.a(this.a, new fxv(new fxp(this, (fyf)paramObject), (Context)QuizStartActivity.d(this.a), 2130969363, paramObject.a()));
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes2-dex2jar.jar!\fxo.class
