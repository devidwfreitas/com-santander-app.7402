...
public class RequestConfigPanel extends AbstractConnectorRequest {
  private static final String TAG = RequestConfigPanel.class.getName();
  
  private static final String URL = "messaging-internet/v1/checkCategoryMembership";
  
  private String applicationId;
  
  public RequestConfigPanel(RequestProvider paramRequestProvider, String paramString) {
  ...
  public ir createHubRequest() {
    ir ir = new ir();
    ir.a("messaging-internet/v1/checkCategoryMembership");
    ir.a(im.POST);
  ...
  public String getMethod() {
    return "messaging-internet/v1/checkCategoryMembership";
  }
}


/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\br\com\santander\msgsdk\request\RequestConfigPanel.class
