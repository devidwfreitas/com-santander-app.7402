package br.com.santander.investimentoV2.shared.view.PlayGifView;
...
public class PlayGifView extends View implements acl {
  ...
  public void a(int paramInt) {
    this.f = Boolean.valueOf(true);
    invalidate();
    (new Handler()).postDelayed((Runnable)new acn(this), paramInt);
  }
  ...
  public void setGifResourceWithDuration(int paramInt1, int paramInt2) {
    ...
    this.c = Movie.decodeStream(getResources().openRawResource(this.b));
    requestLayout();
    (new Handler()).postDelayed((Runnable)new acm(this), paramInt2);
  }
}


/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\br\com\santander\investimentoV2\shared\view\PlayGifView\PlayGifView.class
