...
public class ald implements alc {
  ...
  public int a(String paramString, OutputStream paramOutputStream) {
    int i = 0;
    int j;
    for (j = paramString.length(); j > 0 && a(paramString.charAt(j - 1)); j--);
    int k = 0;
    while (i < j) {
  ...
  public int b(byte[] paramArrayOfbyte, int paramInt1, int paramInt2, OutputStream paramOutputStream) {
    for (paramInt2 = paramInt1 + paramInt2; paramInt2 > paramInt1 && a((char)paramArrayOfbyte[paramInt2 - 1]); paramInt2--);
    int i = 0;
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\ald.class
