...
public class akg implements SharedPreferences {
  ...
  public akg(Context paramContext, SharedPreferences paramSharedPreferences) {
  ...
  public static akg a(Context paramContext, String paramString, int paramInt) {
    // Byte code:
    //   0: ldc akg
    //   2: monitorenter
    //   3: new akg
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\akg.class
