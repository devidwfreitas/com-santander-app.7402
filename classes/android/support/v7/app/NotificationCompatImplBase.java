...
class NotificationCompatImplBase {
  ...
  public static RemoteViews applyStandardTemplate(Context paramContext, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, int paramInt1, int paramInt2, Bitmap paramBitmap, CharSequence paramCharSequence4, boolean paramBoolean1, long paramLong, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean2) {
    ...
    if (paramBitmap != null) {
      ...
      if (paramInt2 != 0) {
        ...
        paramInt5 = resources.getDimensionPixelSize(R.dimen.notification_small_icon_background_padding);
        if (Build.VERSION.SDK_INT >= 21) {
          bitmap = createIconWithBackground(paramContext, paramInt2, paramInt3, paramInt3 - paramInt5 * 2, paramInt4);
  ...
  public static RemoteViews applyStandardTemplateWithActions(Context paramContext, CharSequence paramCharSequence1, CharSequence paramCharSequence2, CharSequence paramCharSequence3, int paramInt1, int paramInt2, Bitmap paramBitmap, CharSequence paramCharSequence4, boolean paramBoolean1, long paramLong, int paramInt3, int paramInt4, int paramInt5, boolean paramBoolean2, ArrayList<NotificationCompat.Action> paramArrayList) {
    ...
    //   79: checkcast android/support/v4/app/NotificationCompat$Action
    //   82: invokestatic generateActionButton : (Landroid/content/Context;Landroid/support/v4/app/NotificationCompat$Action;)Landroid/widget/RemoteViews;
    //   85: astore_2
    //   86: aload_1
    //   87: getstatic android/support/v7/appcompat/R$id.actions : I
    //   90: aload_2
    //   91: invokevirtual addView : (ILandroid/widget/RemoteViews;)V
    //   94: iload #5
    //   96: iconst_1
    //   97: iadd
    //   98: istore #5
    ...
    //   112: istore #4
    //   114: aload_1
    //   115: getstatic android/support/v7/appcompat/R$id.actions : I
    //   118: iload #4
    //   120: invokevirtual setViewVisibility : (II)V
    //   123: aload_1
    //   124: getstatic android/support/v7/appcompat/R$id.action_divider : I
    //   127: iload #4
    //   129: invokevirtual setViewVisibility : (II)V
    //   132: aload_1
    //   133: areturn
    //   134: bipush #8
    //   136: istore #4
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\app\NotificationCompatImplBase.class
