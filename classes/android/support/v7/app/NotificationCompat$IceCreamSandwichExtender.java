...
class NotificationCompat$IceCreamSandwichExtender extends NotificationCompat.BuilderExtender {
  public Notification build(NotificationCompat.Builder paramBuilder, NotificationBuilderWithBuilderAccessor paramNotificationBuilderWithBuilderAccessor) {
    RemoteViews remoteViews = NotificationCompat.access$300(paramNotificationBuilderWithBuilderAccessor, paramBuilder);
    ...
    if (paramBuilder.getContentView() != null) {
      notification.contentView = paramBuilder.getContentView();
      return notification;
    } 
    return notification;
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\app\NotificationCompat$IceCreamSandwichExtender.class
