...
public class SwitchCompat extends CompoundButton {
  ...
  private void animateThumbToCheckedState(boolean paramBoolean) {
    ...
    this.mPositionAnimator = new SwitchCompat$ThumbAnimation(this, f2, f1);
    this.mPositionAnimator.setDuration(250L);
    this.mPositionAnimator.setAnimationListener(new SwitchCompat$1(this, paramBoolean));
  ...
  public void draw(Canvas paramCanvas) {
    ...
    if (this.mTrackDrawable != null) {
      ...
      if (rect1 != null) {
        ...
        if (rect1.top > rect2.top) {
          j = rect1.top - rect2.top + k;
        } else {
          j = k;
        } 
        i3 = n;
        if (rect1.right > rect2.right)
          i3 = n - rect1.right - rect2.right; 
        if (rect1.bottom > rect2.bottom) {
          i2 = m - rect1.bottom - rect2.bottom;
        } else {
          i2 = m;
        } 
      } else {
      ...
      this.mTrackDrawable.setBounds(i, j, i3, i2);
      i = i4 + i1;
    } else {
      i = i1;
    } 
    if (this.mThumbDrawable != null) {
      ...
      j = i - rect2.left;
      i = i + this.mThumbWidth + rect2.right;
      this.mThumbDrawable.setBounds(j, k, i, m);
      Drawable drawable = getBackground();
      if (drawable != null)
        DrawableCompat.setHotspotBounds(drawable, j, k, i, m); 
    } 
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\widget\SwitchCompat.class
