...
public class MenuPopupHelper implements MenuHelper {
  ...
  private void showPopup(int paramInt1, int paramInt2, boolean paramBoolean1, boolean paramBoolean2) {
    ...
    if (paramBoolean1) {
      ...
      menuPopup.setEpicenterBounds(new Rect(i - paramInt1, paramInt2 - paramInt1, i + paramInt1, paramInt1 + paramInt2));
    } 
    menuPopup.show();
  }
  ...
  public void setPresenterCallback(@Nullable MenuPresenter$Callback paramMenuPresenter$Callback) {
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\view\menu\MenuPopupHelper.class
