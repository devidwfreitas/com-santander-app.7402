...
public class MenuAdapter extends BaseAdapter {
  ...
  public View getView(int paramInt, View paramView, ViewGroup paramViewGroup) {
    ...
    MenuView$ItemView menuView$ItemView = (MenuView$ItemView)paramView;
    if (this.mForceShowIcon)
      ((ListMenuItemView)paramView).setForceShowIcon(true); 
    menuView$ItemView.initialize(getItem(paramInt), 0);
    return paramView;
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\view\menu\MenuAdapter.class
