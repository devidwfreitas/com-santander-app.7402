...
public class StandaloneActionMode extends ActionMode implements MenuBuilder.Callback {
  ...
  public StandaloneActionMode(Context paramContext, ActionBarContextView paramActionBarContextView, ActionMode$Callback paramActionMode$Callback, boolean paramBoolean) {
    this.mContext = paramContext;
    this.mContextView = paramActionBarContextView;
    this.mCallback = paramActionMode$Callback;
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\view\StandaloneActionMode.class
