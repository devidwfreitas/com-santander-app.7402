...
public final class AppCompatResources {
  ...
  private static final WeakHashMap<Context, SparseArray<AppCompatResources$ColorStateListCacheEntry>> sColorStateCaches = new WeakHashMap<Context, SparseArray<AppCompatResources$ColorStateListCacheEntry>>(0);
  ...
  private static void addColorStateListToCache(@NonNull Context paramContext, @ColorRes int paramInt, @NonNull ColorStateList paramColorStateList) {
    synchronized (sColorStateCacheLock) {
      SparseArray<AppCompatResources$ColorStateListCacheEntry> sparseArray2 = sColorStateCaches.get(paramContext);
      SparseArray<AppCompatResources$ColorStateListCacheEntry> sparseArray1 = sparseArray2;
      if (sparseArray2 == null) {
        sparseArray1 = new SparseArray();
        sColorStateCaches.put(paramContext, sparseArray1);
      } 
      sparseArray1.append(paramInt, new AppCompatResources$ColorStateListCacheEntry(paramColorStateList, paramContext.getResources().getConfiguration()));
      return;
    } 
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v7\content\res\AppCompatResources.class
