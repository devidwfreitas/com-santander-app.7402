...
public class BottomNavigationView extends FrameLayout {
  ...
  protected void onRestoreInstanceState(Parcelable paramParcelable) {
    ...
    BottomNavigationView$SavedState bottomNavigationView$SavedState = (BottomNavigationView$SavedState)paramParcelable;
    super.onRestoreInstanceState(bottomNavigationView$SavedState.getSuperState());
    this.mMenu.restorePresenterStates(bottomNavigationView$SavedState.menuPresenterState);
  }
  ...
  protected Parcelable onSaveInstanceState() {
    ...
    bottomNavigationView$SavedState.menuPresenterState = new Bundle();
    this.mMenu.savePresenterStates(bottomNavigationView$SavedState.menuPresenterState);
    return (Parcelable)bottomNavigationView$SavedState;
  }
  ...
  public void setOnNavigationItemReselectedListener(@Nullable BottomNavigationView$OnNavigationItemReselectedListener paramBottomNavigationView$OnNavigationItemReselectedListener) {
    this.mReselectedListener = paramBottomNavigationView$OnNavigationItemReselectedListener;
  }
  
  public void setOnNavigationItemSelectedListener(@Nullable BottomNavigationView$OnNavigationItemSelectedListener paramBottomNavigationView$OnNavigationItemSelectedListener) {
    this.mSelectedListener = paramBottomNavigationView$OnNavigationItemSelectedListener;
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\BottomNavigationView.class
