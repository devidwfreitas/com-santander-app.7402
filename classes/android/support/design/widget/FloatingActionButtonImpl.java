...
abstract class FloatingActionButtonImpl {
  ...
  FloatingActionButtonImpl(VisibilityAwareImageButton paramVisibilityAwareImageButton, ShadowViewDelegate paramShadowViewDelegate, ValueAnimatorCompat$Creator paramValueAnimatorCompat$Creator) {
    this.mView = paramVisibilityAwareImageButton;
    this.mShadowViewDelegate = paramShadowViewDelegate;
    this.mAnimatorCreator = paramValueAnimatorCompat$Creator;
  }
  ...
  abstract void hide(@Nullable FloatingActionButtonImpl$InternalVisibilityChangedListener paramFloatingActionButtonImpl$InternalVisibilityChangedListener, boolean paramBoolean);
  ...
  abstract void show(@Nullable FloatingActionButtonImpl$InternalVisibilityChangedListener paramFloatingActionButtonImpl$InternalVisibilityChangedListener, boolean paramBoolean);
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\design\widget\FloatingActionButtonImpl.class
