  ...
  private void updateCurrentScene(View paramView) {
    if (sSetCurrentScene == null)
      try {
        ...
        try {
          sSetCurrentScene.invoke(null, new Object[] { paramView, this.mScene });
          return;
    ...
    try {
      sSetCurrentScene.invoke(null, new Object[] { noSuchMethodException, this.mScene });
      return;
    } catch (IllegalAccessException illegalAccessException) {
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\transition\SceneKitKat.class
