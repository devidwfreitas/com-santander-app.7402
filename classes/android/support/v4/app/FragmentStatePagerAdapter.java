...
public abstract class FragmentStatePagerAdapter extends PagerAdapter {
  ...
  public void destroyItem(ViewGroup paramViewGroup, int paramInt, Object paramObject) {
    ...
    if (paramObject.isAdded()) {
      Fragment$SavedState fragment$SavedState = this.mFragmentManager.saveFragmentInstanceState((Fragment)paramObject);
    } else {
      paramViewGroup = null;
    } 
  ...
  public Object instantiateItem(ViewGroup paramViewGroup, int paramInt) {
    ...
    if (this.mSavedState.size() > paramInt) {
      Fragment$SavedState fragment$SavedState = this.mSavedState.get(paramInt);
  ...
  public Parcelable saveState() {
    ...
    if (this.mSavedState.size() > 0) {
      bundle = new Bundle();
      Fragment$SavedState[] arrayOfFragment$SavedState = new Fragment$SavedState[this.mSavedState.size()];
      this.mSavedState.toArray(arrayOfFragment$SavedState);
      bundle.putParcelableArray("states", (Parcelable[])arrayOfFragment$SavedState);
    } 
    int i = 0;
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\FragmentStatePagerAdapter.class
