...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener {
  ...
  public static Fragment instantiate(Context paramContext, String paramString, @Nullable Bundle paramBundle) {
    try {
      ...
      throw new Fragment$InstantiationException("Unable to instantiate fragment " + paramString + ": make sure class name exists, is public, and has an" + " empty constructor that is public", classNotFoundException);
  ...
  public boolean getAllowEnterTransitionOverlap() {
    return (this.mAnimationInfo == null || Fragment$AnimationInfo.access$600(this.mAnimationInfo) == null) ? true : Fragment$AnimationInfo.access$600(this.mAnimationInfo).booleanValue();
  }
  
  public boolean getAllowReturnTransitionOverlap() {
    return (this.mAnimationInfo == null || Fragment$AnimationInfo.access$700(this.mAnimationInfo) == null) ? true : Fragment$AnimationInfo.access$700(this.mAnimationInfo).booleanValue();
  }
  ...
  public Object getEnterTransition() {
    return (this.mAnimationInfo == null) ? null : Fragment$AnimationInfo.access$000(this.mAnimationInfo);
  }
  ...
  public Object getExitTransition() {
    return (this.mAnimationInfo == null) ? null : Fragment$AnimationInfo.access$200(this.mAnimationInfo);
  }
  ...
  public Object getReenterTransition() {
    return (this.mAnimationInfo == null) ? null : ((Fragment$AnimationInfo.access$300(this.mAnimationInfo) == USE_DEFAULT_TRANSITION) ? getExitTransition() : Fragment$AnimationInfo.access$300(this.mAnimationInfo));
  }
  ...
  public Object getReturnTransition() {
    return (this.mAnimationInfo == null) ? null : ((Fragment$AnimationInfo.access$100(this.mAnimationInfo) == USE_DEFAULT_TRANSITION) ? getEnterTransition() : Fragment$AnimationInfo.access$100(this.mAnimationInfo));
  }
  
  public Object getSharedElementEnterTransition() {
    return (this.mAnimationInfo == null) ? null : Fragment$AnimationInfo.access$400(this.mAnimationInfo);
  }
  
  public Object getSharedElementReturnTransition() {
    return (this.mAnimationInfo == null) ? null : ((Fragment$AnimationInfo.access$500(this.mAnimationInfo) == USE_DEFAULT_TRANSITION) ? getSharedElementEnterTransition() : Fragment$AnimationInfo.access$500(this.mAnimationInfo));
  }
  ...
  public void onPause() {
    try {
      ...
      CaMDOIntegration.onPauseOfFragment(str, (Activity)getActivity());
    } 
  }
  ...
  public void onResume() {
    try {
      ...
      if (str.length() == 0)
        str = getClass().getName(); 
      CaMDOIntegration.onResumeOfFragment(str, (Activity)getActivity());
    } 
  }
  ...
  @CallSuper
  public void org_onPause() {
    this.mCalled = true;
  }
  
  @CallSuper
  public void org_onResume() {
    this.mCalled = true;
  }
  ...
  public void setInitialSavedState(Fragment$SavedState paramFragment$SavedState) {
    if (this.mIndex >= 0)
      throw new IllegalStateException("Fragment already active"); 
    if (paramFragment$SavedState != null && paramFragment$SavedState.mState != null) {
      Bundle bundle = paramFragment$SavedState.mState;
    } else {
      paramFragment$SavedState = null;
    } 
    this.mSavedFragmentState = (Bundle)paramFragment$SavedState;
  }
  ...
  void setOnStartEnterTransitionListener(Fragment$OnStartEnterTransitionListener paramFragment$OnStartEnterTransitionListener) {
    ensureAnimationInfo();
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\app\Fragment.class
