...
class ViewPropertyAnimatorCompatICS {
  ...
  public static void setListener(View paramView, ViewPropertyAnimatorListener paramViewPropertyAnimatorListener) {
    if (paramViewPropertyAnimatorListener != null) {
      paramView.animate().setListener((Animator.AnimatorListener)new ViewPropertyAnimatorCompatICS$1(paramViewPropertyAnimatorListener, paramView));
      return;
    } 
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\view\ViewPropertyAnimatorCompatICS.class
