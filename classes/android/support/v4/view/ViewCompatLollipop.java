...
class ViewCompatLollipop {
  ...
  public static void setOnApplyWindowInsetsListener(View paramView, ViewCompatLollipop$OnApplyWindowInsetsListenerBridge paramViewCompatLollipop$OnApplyWindowInsetsListenerBridge) {
    if (paramViewCompatLollipop$OnApplyWindowInsetsListenerBridge == null) {
      paramView.setOnApplyWindowInsetsListener(null);
      return;
    } 
    paramView.setOnApplyWindowInsetsListener(new ViewCompatLollipop$1(paramViewCompatLollipop$OnApplyWindowInsetsListenerBridge));
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\view\ViewCompatLollipop.class
