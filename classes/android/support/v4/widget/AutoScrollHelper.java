...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  boolean shouldAnimate() {
    ...
    int i = autoScrollHelper$ClampedScroller.getVerticalDirection();
    int j = autoScrollHelper$ClampedScroller.getHorizontalDirection();
    return ((i != 0 && canTargetScrollVertically(i)) || (j != 0 && canTargetScrollHorizontally(j)));
  }
}


/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\AutoScrollHelper.class
