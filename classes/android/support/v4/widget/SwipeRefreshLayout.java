...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent {
  ...
  private void finishSpinner(float paramFloat) {
    ...
    SwipeRefreshLayout$5 swipeRefreshLayout$5 = null;
    if (!this.mScale)
      swipeRefreshLayout$5 = new SwipeRefreshLayout$5(this); 
    animateOffsetToStartPosition(this.mCurrentTargetOffsetTop, swipeRefreshLayout$5);
  ...
  private Animation startAlphaAnimation(int paramInt1, int paramInt2) {
    if (this.mScale && isAlphaUsedForScale())
      return null; 
    SwipeRefreshLayout$4 swipeRefreshLayout$4 = new SwipeRefreshLayout$4(this, paramInt1, paramInt2);
  ...
  public void setOnChildScrollUpCallback(@Nullable SwipeRefreshLayout$OnChildScrollUpCallback paramSwipeRefreshLayout$OnChildScrollUpCallback) {
    this.mChildScrollUpCallback = paramSwipeRefreshLayout$OnChildScrollUpCallback;
  }
  
  public void setOnRefreshListener(SwipeRefreshLayout$OnRefreshListener paramSwipeRefreshLayout$OnRefreshListener) {
    this.mListener = paramSwipeRefreshLayout$OnRefreshListener;
  }
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\SwipeRefreshLayout.class
