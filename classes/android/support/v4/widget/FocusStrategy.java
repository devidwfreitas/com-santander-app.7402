...
class FocusStrategy {
  ...
  public static <L, T> T findNextFocusInAbsoluteDirection(@NonNull L paramL, @NonNull FocusStrategy$CollectionAdapter<L, T> paramFocusStrategy$CollectionAdapter, @NonNull FocusStrategy$BoundsAdapter<T> paramFocusStrategy$BoundsAdapter, @Nullable T paramT, @NonNull Rect paramRect, int paramInt) {
    // Byte code:
  ...
  public static <L, T> T findNextFocusInRelativeDirection(@NonNull L paramL, @NonNull FocusStrategy$CollectionAdapter<L, T> paramFocusStrategy$CollectionAdapter, @NonNull FocusStrategy$BoundsAdapter<T> paramFocusStrategy$BoundsAdapter, @Nullable T paramT, int paramInt, boolean paramBoolean1, boolean paramBoolean2) {
    int j = paramFocusStrategy$CollectionAdapter.size(paramL);
    ArrayList<?> arrayList = new ArrayList(j);
    int i;
    for (i = 0; i < j; i++)
      arrayList.add(paramFocusStrategy$CollectionAdapter.get(paramL, i)); 
    Collections.sort(arrayList, new FocusStrategy$SequentialComparator(paramBoolean1, paramFocusStrategy$BoundsAdapter));
    switch (paramInt) {
      default:
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\widget\FocusStrategy.class
