...
class MediaBrowserServiceCompat$MediaBrowserServiceImplApi24$1 extends MediaBrowserServiceCompat$Result<List<MediaBrowserCompat$MediaItem>> {
  MediaBrowserServiceCompat$MediaBrowserServiceImplApi24$1(Object paramObject) {
    super(paramObject);
  }
  ...
  void onResultSent(List<MediaBrowserCompat$MediaItem> paramList, int paramInt) {
    ...
    resultWrapper.sendResult(arrayList, paramInt);
  }
}


/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\android\support\v4\media\MediaBrowserServiceCompat$MediaBrowserServiceImplApi24$1.class
