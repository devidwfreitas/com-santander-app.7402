...
final class anz extends ColorDrawable {
  ...
  anz(@ColorInt int paramInt1, int paramInt2) {
    this.c = aoo.a(paramInt2);
    this.b = 0;
...
/* Location:              C:\Users\devid\Downloads\SAST\Santander\dex2jar-2.0\classes-dex2jar.jar!\anz.class
