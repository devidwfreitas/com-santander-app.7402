...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Lahw;->a:Lahg;

    invoke-static {v0}, Lahg;->b(Lahg;)Lajg;
    ...
    iget-object v1, p0, Lahw;->a:Lahg;

    invoke-static {v1}, Lahg;->a(Lahg;)Landroid/app/Activity;

    move-result-object v1

    sget v2, Lagl;->tag_valor_emprestimos:I
    ...
    iget-object v3, p0, Lahw;->a:Lahg;

    invoke-static {v3}, Lahg;->b(Lahg;)Lajg;

    move-result-object v3

    invoke-virtual {v3}, Lajg;->r()Ljava/util/List;

    move-result-object v3

    new-instance v4, Lahx;

    invoke-direct {v4, p0}, Lahx;-><init>(Lahw;)V

    invoke-virtual {v4}, Lahx;->getType()Ljava/lang/reflect/Type;
    ...
    iget-object v2, p0, Lahw;->a:Lahg;

    invoke-static {v2}, Lahg;->a(Lahg;)Landroid/app/Activity;

    move-result-object v2

    sget v3, Lagl;->meus_emprestimos:I
    ...
    invoke-virtual {v0}, Lajg;->r()Ljava/util/List;
