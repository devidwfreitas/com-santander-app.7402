...
.method static constructor <clinit>()V
    ...
    sput-boolean v1, Lcwv;->h:Z

    sput-boolean v1, Lcwv;->i:Z

    sput-boolean v1, Lcwv;->j:Z

    sput-boolean v1, Lcwv;->a:Z

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcwv;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    sput-object v0, Lcwv;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static a(Landroid/content/Context;)V
    ...
    sget-object v0, Lcwv;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_1
    invoke-static {p0}, Lcvd;->b(Landroid/content/Context;)I
...
.method public static a(Landroid/content/Context;ILjava/lang/String;)Z
    ...
    invoke-static {p0, p1, p2}, Lcwi;->a(Landroid/content/Context;ILjava/lang/String;)Z
...
.method static a(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    invoke-static {p0}, Lcwv;->n(Landroid/content/Context;)Z
    :try_end_0
...
.method public static b(ILandroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v0, p1, p0, p2}, Lcwn;->a(Landroid/content/Context;II)Landroid/app/PendingIntent;
...
.method private static b(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcwv;->c(Landroid/content/Context;)V
...
.method private static c(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, v1, v2}, Ldgk;->b(Ljava/lang/String;I)Landroid/content/pm/PackageInfo;

    move-result-object v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lcww;->a(Landroid/content/Context;)Lcww;

    move-result-object v1

    const/4 v2, 0x1

    new-array v2, v2, [Lcwp;

    const/4 v3, 0x0

    sget-object v4, Lcws;->a:[Lcwp;
    ...
    invoke-virtual {v1, v0, v2}, Lcww;->a(Landroid/content/pm/PackageInfo;[Lcwp;)Lcwp;
    ...
    sput-boolean v0, Lcwv;->j:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :goto_0
    sput-boolean v6, Lcwv;->a:Z
...
.method public static c(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lcwi;->a(Landroid/content/Context;I)Z
...
.method public static d(Landroid/content/Context;I)Z
    ...
    invoke-static {p0, v0}, Lcwv;->a(Landroid/content/Context;Ljava/lang/String;)Z
...
.method public static e(Landroid/content/Context;)I
    ...
    sget v4, Lcns;->common_google_play_services_unknown_issue:I
    ...
    invoke-static {p0}, Lcwv;->a(Landroid/content/Context;)V

    :cond_0
    invoke-static {p0}, Lcvt;->b(Landroid/content/Context;)Z

    move-result v3

    if-nez v3, :cond_2

    invoke-static {p0}, Lcvt;->d(Landroid/content/Context;)Z
    ...
    invoke-virtual {v7, v3, v4}, Lcww;->a(Landroid/content/pm/PackageInfo;[Lcwp;)Lcwp;
    ...
    :cond_3
    new-array v4, v1, [Lcwp;

    aput-object v3, v4, v2

    invoke-virtual {v7, v6, v4}, Lcww;->a(Landroid/content/pm/PackageInfo;[Lcwp;)Lcwp;
    ...
    invoke-virtual {v7, v6, v3}, Lcww;->a(Landroid/content/pm/PackageInfo;[Lcwp;)Lcwp;
    ...
    invoke-static {v0}, Lcvw;->a(I)I

    move-result v0

    iget v3, v6, Landroid/content/pm/PackageInfo;->versionCode:I

    invoke-static {v3}, Lcvw;->a(I)I
...
.method public static f(Landroid/content/Context;)V
    ...
    invoke-virtual {v1, p0, v0, v2}, Lcwn;->b(Landroid/content/Context;ILjava/lang/String;)Landroid/content/Intent;
    ...
    invoke-direct {v1, v0}, Lcop;-><init>(I)V
    ...
    invoke-direct {v2, v0, v3, v1}, Lcoq;-><init>(ILjava/lang/String;Landroid/content/Intent;)V
...
.method public static g(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcwv;->b(Landroid/content/Context;)V

    sget-boolean v0, Lcwv;->j:Z
...
.method public static h(Landroid/content/Context;)Z
    ...
    invoke-static {p0}, Lcwv;->g(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lcwv;->a()Z
...
.method public static i(Landroid/content/Context;)V
    ...
    sget-object v0, Lcwv;->k:Ljava/util/concurrent/atomic/AtomicBoolean;
