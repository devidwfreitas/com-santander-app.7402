...
.method static synthetic a(Lfz;)Landroid/content/Context;
    .locals 1
...
.method static synthetic a(Ljava/util/Map;Landroid/net/Uri;)Lek;
    .locals 1

    .prologue
    .line 40
    invoke-static {p0, p1}, Lfz;->b(Ljava/util/Map;Landroid/net/Uri;)Lek;
...
.method static synthetic a(Ljava/net/URLConnection;)Ljava/lang/String;
    ...
    .prologue
    .line 40
    invoke-static {p0}, Lfz;->b(Ljava/net/URLConnection;)Ljava/lang/String;
...
.method static synthetic a(Lorg/json/JSONArray;)Ljava/util/Map;
    ...
    .prologue
    .line 40
    invoke-static {p0}, Lfz;->b(Lorg/json/JSONArray;)Ljava/util/Map;
...
.method private static b(Ljava/util/Map;Landroid/net/Uri;)Lek;
    .locals 13
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1}, Lfz;->a(Ljava/util/Map;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 259
    invoke-static {v0}, Lfz;->a(Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-direct {v12, v0, v1, v11, v2}, Lel;-><init>(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p1, v4, v0}, Lek;-><init>(Landroid/net/Uri;Ljava/util/List;Landroid/net/Uri;)V
...
.method public a(Landroid/net/Uri;)Lfd;
    ...
    invoke-direct {v2, p0, p1, v0, v1}, Lge;-><init>(Lfz;Landroid/net/Uri;Lez;Lez;)V

    invoke-static {v2}, Lfd;->a(Ljava/util/concurrent/Callable;)Lfd;

    move-result-object v2

    new-instance v3, Lgb;

    invoke-direct {v3, p0, v1, p1, v0}, Lgb;-><init>(Lfz;Lez;Landroid/net/Uri;Lez;)V

    sget-object v0, Lfd;->b:Ljava/util/concurrent/Executor;

    invoke-virtual {v2, v3, v0}, Lfd;->d(Lfa;Ljava/util/concurrent/Executor;)Lfd;

    move-result-object v0

    new-instance v1, Lga;

    invoke-direct {v1, p0, p1}, Lga;-><init>(Lfz;Landroid/net/Uri;)V
