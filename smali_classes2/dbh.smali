...
.field private b:Lddz;


# direct methods
.method constructor <init>(Ldbe;Lddz;)V
    .locals 0

    iput-object p1, p0, Ldbh;->a:Ldbe;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Ldbh;->b:Lddz;
...
.method public a(Legv;)V
    ...
    iget-object v2, p0, Ldbh;->a:Ldbe;

    invoke-static {v2}, Ldbe;->m(Ldbe;)Ljava/util/Map;
    ...
    invoke-static {v0, v1}, Ldbe;->b(Ldbe;Ljava/util/Map;)Ljava/util/Map;

    iget-object v0, p0, Ldbh;->a:Ldbe;

    invoke-static {v0}, Ldbe;->m(Ldbe;)Ljava/util/Map;
    ...
    invoke-static {v2}, Ldbe;->g(Ldbe;)Ljava/util/Map;
    ...
    iget-object v3, p0, Ldbh;->a:Ldbe;

    invoke-static {v3}, Ldbe;->m(Ldbe;)Ljava/util/Map;
    ...
    invoke-static {v1, v2}, Ldbe;->b(Ldbe;Ljava/util/Map;)Ljava/util/Map;

    iget-object v1, p0, Ldbh;->a:Ldbe;

    invoke-static {v1}, Ldbe;->m(Ldbe;)Ljava/util/Map;
    ...
    invoke-static {v1, v0}, Ldbe;->b(Ldbe;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {v0}, Ldbe;->f(Ldbe;)Lcom/google/android/gms/common/ConnectionResult;
