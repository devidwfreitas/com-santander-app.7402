...
.method protected final a(Landroid/content/Context;)Ljava/lang/Object;
    ...
    iget-object v0, p0, Lcxq;->b:Ljava/lang/Object;

    if-nez v0, :cond_1

    invoke-static {p1}, Lcsp;->a(Ljava/lang/Object;)Ljava/lang/Object;

    invoke-static {p1}, Lcwv;->l(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-direct {v0, v1}, Lcxr;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0}, Lcxq;->b(Landroid/os/IBinder;)Ljava/lang/Object;

    move-result-object v0

    iput-object v0, p0, Lcxq;->b:Ljava/lang/Object;
    :try_end_0
