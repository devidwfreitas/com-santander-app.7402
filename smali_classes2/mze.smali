...
.method public static a(I[Ljava/lang/String;[ILandroid/app/Activity;)Ljava/lang/String;
    .locals 10
    ...
    const-string v1, " ao armazenamento"
    ...
    invoke-static {p3, v0}, Landroid/support/v4/app/ActivityCompat;->shouldShowRequestPermissionRationale(Landroid/app/Activity;Ljava/lang/String;)Z
    ...
    const-string v3, "Se voc\u00ea negar ao aplicativo o acesso "
    ...
    const-string v1, ", voc\u00ea n\u00e3o poder\u00e1 tirar foto para o perfil"
    ...
    .line 97
    const-string v1, "Outros_Permisssoes_Tratamento_Excecao"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "validarPermissoesPermitidas() "
...
.method public static a(Ljava/lang/String;IZLandroid/app/Activity;)V
    ...
    invoke-direct {v1, p3, v0}, Landroid/app/Dialog;-><init>(Landroid/content/Context;I)V
    ...
    invoke-direct {v4, v1, p3}, Lmzf;-><init>(Landroid/app/Dialog;Landroid/app/Activity;)V
    ...
    invoke-direct {v5, p1, v1}, Lmzg;-><init>(ILandroid/app/Dialog;)V
    ...
    invoke-direct {v4, p1, v1}, Lmzh;-><init>(ILandroid/app/Dialog;)V
    ...
    invoke-direct {v5, v1, p1, p3}, Lmzi;-><init>(Landroid/app/Dialog;ILandroid/app/Activity;)V
