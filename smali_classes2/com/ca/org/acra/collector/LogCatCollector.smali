.class Lcom/ca/org/acra/collector/LogCatCollector;
...
.method public static collectLogCat(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lcom/ca/org/acra/ACRAConfiguration;->logcatFilterByPid()Z
    ...
    invoke-virtual {v11}, Lcom/ca/org/acra/ACRAConfiguration;->logcatArguments()[Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    new-instance v5, Lcom/ca/org/acra/util/BoundedLinkedList;

    if-lez v9, :cond_5

    .end local v9    # "tailCount":I
    :goto_1
    invoke-direct {v5, v9}, Lcom/ca/org/acra/util/BoundedLinkedList;-><init>(I)V
