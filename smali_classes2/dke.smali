...
# direct methods
.method constructor <init>(Ldkb;Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method public getWritableDatabase()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v0}, Ldkb;->a(Ldkb;)Ldop;

    move-result-object v0

    iget-object v1, p0, Ldke;->a:Ldkb;

    invoke-virtual {v1}, Ldkb;->w()Ldka;

    move-result-object v1

    invoke-virtual {v1}, Ldka;->O()J

    move-result-wide v2

    invoke-virtual {v0, v2, v3}, Ldop;->a(J)Z
    ...
    invoke-virtual {v1}, Ldkb;->n()Landroid/content/Context;
    ...
    invoke-static {v1}, Ldkb;->a(Ldkb;)Ldop;

    move-result-object v1

    invoke-virtual {v1}, Ldop;->b()V
    :try_end_1
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static {v0, p1}, Ldkb;->a(Ldkw;Landroid/database/sqlite/SQLiteDatabase;)V
...
.method public onOpen(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    invoke-static/range {v0 .. v5}, Ldkb;->a(Ldkw;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {}, Ldkb;->L()Ljava/util/Map;

    move-result-object v11

    move-object v7, p1

    invoke-static/range {v6 .. v11}, Ldkb;->a(Ldkw;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {}, Ldkb;->M()Ljava/util/Map;
    ...
    invoke-static {}, Ldkb;->N()Ljava/util/Map;
    ...
    invoke-static {}, Ldkb;->O()Ljava/util/Map;
    ...
    invoke-static {}, Ldkb;->P()Ljava/util/Map;
