...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Ldaf;-><init>(Ldag;)V
...
.method public constructor <init>(Ldag;)V
    ...
    invoke-direct {p0, p1, v0}, Ldaf;-><init>(Ldag;Ljavax/net/ssl/SSLSocketFactory;)V

    return-void
.end method

.method public constructor <init>(Ldag;Ljavax/net/ssl/SSLSocketFactory;)V
    .locals 0
    ...
    iput-object p2, p0, Ldaf;->b:Ljavax/net/ssl/SSLSocketFactory;

    return-void
.end method

.method private a(Ljava/net/URL;Ldsa;)Ljava/net/HttpURLConnection;
    .locals 3
    ...
    invoke-virtual {p0, p1}, Ldaf;->a(Ljava/net/URL;)Ljava/net/HttpURLConnection;

    move-result-object v1

    invoke-virtual {p2}, Ldsa;->n()I
    ...
    iget-object v0, p0, Ldaf;->b:Ljavax/net/ssl/SSLSocketFactory;
    ...
    iget-object v2, p0, Ldaf;->b:Ljavax/net/ssl/SSLSocketFactory;
...
.method static a(Ljava/net/HttpURLConnection;Ldsa;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Ldsa;->g()Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Ldaf;->b(Ljava/net/HttpURLConnection;Ldsa;)V
...
.method private static b(Ljava/net/HttpURLConnection;Ldsa;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Ldsa;->j()Ljava/lang/String;
...
.method public a(Ldsa;Ljava/util/Map;)Lorg/apache/http/HttpResponse;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p1}, Ldsa;->c()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Ldsa;->f()Ljava/util/Map;
    ...
    invoke-interface {v0, v1}, Ldag;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1, p1}, Ldaf;->a(Ljava/net/URL;Ldsa;)Ljava/net/HttpURLConnection;
    ...
    :cond_2
    invoke-static {v3, p1}, Ldaf;->a(Ljava/net/HttpURLConnection;Ldsa;)V
    ...
    invoke-static {v0, v1}, Ldaf;->a(II)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-static {v3}, Ldaf;->a(Ljava/net/HttpURLConnection;)Lorg/apache/http/HttpEntity;
