...
# direct methods
.method constructor <init>(Lwc;Lvz;)V
    .locals 0

    .prologue
    .line 41
    iput-object p1, p0, Lwd;->b:Lwc;

    iput-object p2, p0, Lwd;->a:Lvz;
...
.method public onFailure(Lis;)V
    ...
    invoke-interface {v0, v1}, Lvz;->a(Laby;)V
...
.method public onSuccess(Lis;)V
    ...
    invoke-interface {v1, v0}, Lvz;->a(Lwa;)V
    :try_end_0
    ...
    iget-object v3, p0, Lwd;->b:Lwc;

    invoke-static {v3}, Lwc;->a(Lwc;)Landroid/content/Context;
